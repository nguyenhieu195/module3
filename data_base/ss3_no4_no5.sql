create database if not exists ss3_no45;
use ss3_no45;
 create table james(
...
select * 
from classes c 
inner join instructor_class ic on ic.class_id = c.id
where month(ic.start_day) = 12;
...
select s.name as StudentName, c.name as ClassName, s.score as Mark
from students s
